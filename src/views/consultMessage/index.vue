<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="咨询内容" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.title }}</span>
        </template>
      </el-table-column>
      <el-table-column label="咨询时间" width="180px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="咨询内容" prop="title">
...
<script>
import { fetchList, editData, deleteDate } from '@/api/consultMessage'
